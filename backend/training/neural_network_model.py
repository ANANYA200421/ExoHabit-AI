...
print("=" * 80)
print("NEURAL NETWORK - EXOPLANET HABITABILITY PREDICTION")
print("=" * 80)
...
# SAVE MODEL
joblib.dump(model, 'nn_exoplanet_model.pkl')
print("✓ Saved: nn_exoplanet_model.pkl")

# PREDICTIONS
df_clean['nn_predicted'] = model.predict(X)
df_clean['nn_probability'] = model.predict_proba(X)[:, 1]
df_clean.to_csv('nn_predictions.csv', index=False)
print("✓ Saved: nn_predictions.csv")
